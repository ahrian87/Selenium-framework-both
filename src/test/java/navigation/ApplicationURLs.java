...
public class ApplicationURLs {
    ...
    public static final String JAVASCRIPT_ALERT_URL = APPLICATION_URL + "javascript-alert-box-demo.html";
    public static final String BOOTSTRAP_ALERT_URL = APPLICATION_URL + "bootstrap-alert-messages-demo.html";
}
